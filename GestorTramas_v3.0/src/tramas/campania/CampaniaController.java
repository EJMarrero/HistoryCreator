...
public class CampaniaController implements Initializable {
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		 ...
		 * 
		 */
		aventurasCampaniaList.setCellFactory(e -> new AventuraListCell());
	...
	/**
	 * Siempre que se carge una campaña nueva, este método desbindeará los
	 * elementos: *La lista de notas de Campaña *La lista de Aventuras *La lista de
	 * Personajes *El mapa de la campaña de la campaña vieja y los bindeará a la
	 * campaña nueva.
	 * 
	 * @param o
	 * @param ov
	 ...
	 * carga la vista de AventuraController desde su controlador padre
	 * (MainController)
	 * 
	 * @param event
	 * @throws IOException
	...
	/**
	 * Este método añade una imagen a la zona de mapas de la campaña a través de la
	 * carga de un fichero con extensión .jgp o .png desde el un directorio local.
	 * 
	 * @param event
	 * @throws IOException
	 */
	...
	/**
	 * Abre una ventana nueva en la que se cargan los datos Título y Texto de la
	 * nota de campaña seleccionada
	 * 
	 * @param event
	 * @throws IOException
	 */
	...
	void onExpandirMapaButtonAction(ActionEvent event) {
		...
		mapaController.show(SplashController.getPrimaryStage());
